...
Some of the libraries used in my project are exclusive to Virtual Pascal, as  

First, copy and this URL into your browser to download the Pascal compiler:
...
After the download is complete, extract the files. Open the extracted folder, and locate the application named “setupw32” (Windows), or the equivalent for your operating system. Run it, and allowing it to make changes when necessary.
